...
export const Footer = () => {
    return (
        <div className='h-[18rem] w-full bg-base-300 px-25 py-6'>
            <div className='h-full flex flex-col justify-between'>
                ...
                <div className='grid grid-cols-2 gap-4'>
                    ...
                    <a className='flex items-center hover:text-emerald-400 transition-transform hover:scale-102' href="https://www.linkedin.com/in/wilder-cossio" target="_blank" rel="noopener noreferrer">
                        <FaLinkedin className='text-[20px]' /><span className="ml-4">https://www.linkedin.com/in/wilder-cossio</span>
                    </a>

export const AboutDescription = () => {
    return (
        <div className='flex-4 md:text-end my-6 pb-4'>
            <div className='animate__animated animate__fadeInLeft flex md:flex-row justify-center md:items-center'>
                <div className='hidden md:flex md:flex-1 h-[3px] w-full bg-emerald-400 rounded-sm'></div>
                <p className='bg-primary flex-none ml-6 font-bold text-4xl md:text-5xl lg:text-6xl mb-3 bg-gradient-to-r from-emerald-300 via-emerald-500 to-emerald-700 bg-clip-text text-transparent'>Wilder Cossio</p>
            </div>
            <p className='animate__animated animate__fadeInLeft font-normal text-xl text-center mb-4 lg:mb-0 md:text-end'>Frontend Developer</p>
            <div className='flex items-center animate__animated animate__fadeInLeft' style={{ animationDelay: '0.9s' }}>
                <span className='hidden md:flex font-light text-emerald-400 text-[20rem]'>{'['}</span>

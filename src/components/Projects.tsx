    ...
    return (
        <div className='mx-25 text-center pb-18'>
            ...
            <div className='grid grid-cols-3 gap-6'>
                <ProjectItem technologies={["React", "JavaScript", "HTML5", "CSS3", "DaisyUI", "Zustand", "API Integration"]} title='MiniSocialNetwork' shortDescription='MiniSocialNetwork is a simple and modern platform where users can register, log in, and share posts. It supports creating, editing, and deleting posts with an intuitive interface.' projectLink='https://mini-social-network-olive.vercel.app/' img={MiniTwitterImg}></ProjectItem>
